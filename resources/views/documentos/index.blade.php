                        ...
                        <div class="row">
                            @foreach ($documentos as $documento)
                                @php
                                    ...
                                    $tieneAccesoGerencia = $usuarioAutenticado->rol->privilegios->contains('nombre', 'Acceso a Gerencia');

                                    // Verificar si el usuario tiene el privilegio "Acceso a Subgerencia"
                                    $tieneAccesoSubgerencia = $usuarioAutenticado->rol->privilegios->contains('nombre', 'Acceso a Subgerencia');

                                    // Verificar si el usuario tiene el rol "UsuarioPublicador"
                                    $esUsuarioPublicador = $usuarioAutenticado->rol->nombre === 'UsuarioPublicador';

                                    // Verificar si el usuario tiene el rol "UsuarioValidador"
                                    $esUsuarioValidador = $usuarioAutenticado->rol->nombre === 'UsuarioValidador';

                                    // Determinar si se deben mostrar los botones de edición
                                    $mostrarBotonEditar = ($esUsuarioPublicador && $documento->estado === 'Validado') ||
